...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    Because Storybook works separately from your config, you'll need to configure it for your specific stack and setup. Below, explore guides for configuring Storybook with popular frameworks and tools. If you get stuck, learn how you can ask for help from our community.
  </div>
